    ...
    <div className="">
      <div className="relative bg-linear-to-b from-indigo-100/20 overflow-hidden isolate">
            ...
            <div className="mx-auto max-w-2xl">
              ...
              <div className="mt-24 sm:mt-32 lg:mt-16">
                <a href="#" className="inline-flex space-x-6">
                  <span className="px-3 py-1 rounded-full ring-1 ring-inset font-semibold text-sm/6">
                    What's new
                  </span>
        ...
        <div className="md:mx-auto lg:mx-0 mt-20 sm:mt-24 lg:mt-0 lg:w-screen md:max-w-2xl">
          <div
            className="right-1/2 -z-10 absolute inset-y-0 shadow-indigo-600/10 shadow-xl -mr-10 md:-mr-20 lg:-mr-36 ring-1 w-[200%] skew-x-[-30deg]"
            aria-hidden="true"
          />
          <div className="shadow-lg md:rounded-3xl">
            <div className="[clip-path:inset(0)] md:[clip-path:inset(0_round_var(--radius-3xl))]">
              <div
                className="left-1/2 -z-10 absolute -inset-y-px opacity-20 ml-10 md:ml-20 lg:ml-36 ring-1 ring-inset w-[200%] skew-x-[-30deg]"
                aria-hidden="true"
              />
              <div className="relative px-6 pt-8 sm:pt-16 md:pr-0 md:pl-16">
                <div className="mx-auto md:mx-0 max-w-2xl md:max-w-none">
                  <div className="rounded-tl-xl w-screen overflow-hidden">
                    <div className="flex ring-1">
                      <div className="flex -mb-px font-medium text-sm/6">
                        <div className="px-4 py-2 border-r border-b">
                          NotificationSetting.jsx
                        </div>
                        <div className="px-4 py-2 border-r">App.jsx</div>
                      </div>
                    </div>
                ...
                <div
                  className="absolute inset-0 md:rounded-3xl ring-1 ring-inset pointer-events-none"
                  aria-hidden="true"
                />
              </div>
            </div>
