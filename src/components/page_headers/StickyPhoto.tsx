  ...
  return (
    <div className="relative px-6 lg:px-0 py-24 sm:py-32 overflow-hidden lg:overflow-visible isolate">
      <div className="-z-10 absolute inset-0 overflow-hidden">
        <svg
          aria-hidden="true"
          className="top-0 left-[max(50%,25rem)] absolute w-[128rem] h-[64rem] -translate-x-1/2 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)]"
        >
          <defs>
            <pattern
              x="50%"
          ...
          <svg x="50%" y={-1} className="overflow-visible">
            <path
              d="M-100.5 0h201v201h-201Z M699.5 0h201v201h-201Z M499.5 h201v201h-201Z M-300.5 h201v201h-201Z"
              strokeWidth={0}
            />
          </svg>
          <rect
      ...
      <div className="lg:items-start gap-x-8 gap-y-16 lg:gap-y-10 grid grid-cols-1 lg:grid-cols-2 mx-auto lg:mx-0 max-w-2xl lg:max-w-none">
        ...
        <Image
          ...
          width={1824}
          height={1024}
          className="shadow-xl rounded-xl ring-1 w-[48rem] sm:w-[57rem] max-w-none"
        />
      </div>
