    ...
    <div className="bg-white">
      ...
      <main>
          ...
          <div className="relative bg-gray-900 px-6 sm:px-10 xl:px-24 py-20 sm:py-24 lg:py-24 sm:rounded-3xl overflow-hidden isolate">
            ...
            >
              <div
                ...
                className="bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-25 w-[72.1875rem] aspect-1155/678"
              />
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto mt-32 sm:mt-56 sm:px-6 lg:px-8 max-w-7xl">
          <div className="relative bg-gray-900 shadow-2xl px-6 sm:px-24 py-24 xl:py-32 sm:rounded-3xl overflow-hidden isolate">
            ...
            <svg
              ...
              aria-hidden="true"
              className="top-1/2 left-1/2 -z-10 absolute -translate-x-1/2 size-[64rem]"
            >
              <circle
                r={512}
                cx={512}
        ...
        <div className="relative mt-32 sm:mt-56 sm:pt-32 isolate">
          <svg
            aria-hidden="true"
            className="sm:block -z-10 absolute inset-0 hidden size-full stroke-gray-200 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)]"
          >
            <defs>
              <pattern
                x="50%"
          ...
          <div className="relative">
            ...
            >
              <div
                ...
                className="bg-linear-to-tr from-[#ff80b5] to-[#9089fc] ml-[max(50%,38rem)] w-[82.0625rem] aspect-1313/771"
              />
            </div>
            <div
              aria-hidden="true"
            ...
            >
              <div
                ...
                className="flex-none bg-linear-to-tr from-[#ff80b5] to-[#9089fc] xl:mr-[calc(50%-12rem)] ml-[-22rem] xl:ml-0 w-[82.0625rem] origin-top-right aspect-1313/771 rotate-[30deg]"
              />
            </div>
            <div className="mx-auto px-6 lg:px-8 max-w-7xl">
          ...
          <div className="lg:flex lg:justify-between lg:items-center mt-16 sm:mt-20 lg:mt-24 pt-8 border-white/10 border-t">
            ...
            <form className="sm:flex mt-6 lg:mt-0 sm:max-w-md">
              ...
              <input
                ...
                placeholder="Enter your email"
                autoComplete="email"
                className="bg-white/5 px-3 py-1.5 rounded-md w-full sm:w-56 min-w-0 text-base text-white sm:text-sm/6 placeholder:text-gray-500 outline-1 -outline-offset-1 outline-white/10 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"
              />
              <div className="mt-4 sm:mt-0 sm:ml-4 sm:shrink-0">
                <button
                  type="submit"
                  className="flex justify-center items-center bg-indigo-500 hover:bg-indigo-400 shadow-xs px-3 py-2 rounded-md w-full font-semibold text-sm text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                >
                  Subscribe
                </button>
              </div>
