  ...
  return (
    <div className="flex flex-col justify-center items-center mx-auto px-4 py-20 w-11/12">
      ...
      <p>
        ...
        curriculum into several distinct segments. Each segment is strategically
        crafted to focus on key aspects of learning, allowing students to fully
        engage with the material and make the most of every lesson. This
        segmented structure maximizes educational benefits by targeting specific
        skills and knowledge areas at the right time, enhancing the overall
        learning process.
      </p>
      <p>
        ...
        and interactive learning. This structure promotes continuous engagement,
        fosters a deeper understanding of the subject matter, and helps students
        retain information more effectively. Whether it's introducing new
        concepts, reinforcing previously learned material, or encouraging
        collaborative activities, every segment serves a unique purpose to
        create a comprehensive and enriching educational journey.
      </p>
      <DoughnutChartLabel />
