      ...
      <main>
        <section className="py-12">
          ...
          <p>
            ...
            creativity and innovation in the next generation. These
            collaborations are built on the belief that empowering young minds
            is crucial for shaping a brighter future. Together, we provide
            resources, support, and educational opportunities that encourage
            curiosity, exploration, and inventive thinking. Our collective
            mission is to inspire, mentor, and equip youth with the skills they
            need to become the creators and innovators of tomorrow. We strive to
            cultivate an environment where imagination has no limits, and the
            innovative spirit of the next generation is celebrated. By working
            together, we are shaping a future full of fresh ideas,
            groundbreaking discoveries, and impactful contributions to society.
          </p>

          <p className="leading-relaxed">
            Join our growing network of schools dedicated to fostering
            creativity and innovation in the next generation. Together, we can
            create impactful educational experiences that prepare students for a
            bright future. We are proud to collaborate with a diverse range of
            schools that share our vision of empowering students through
            innovative and enriching educational programs. Here are some of the
            amazing schools we partner with:
          </p>
        ...
        <section className="mb-12">
          ...
          <p>
            The A.R.C. for Education program is designed to create a
            comprehensive and immersive learning experience that integrates
            three core pillars—immersion, effectiveness, and inclusivity—into
            every aspect of the educational journey. Each of these components
            functions harmoniously, much like a well-conducted orchestra,
            ensuring that all students, regardless of age, background, or skill
            level, have the support and resources they need to build a strong
            and lasting educational foundation.
          </p>
          ...
          <p>
            ...
            form the foundation of a powerful educational experience that
            empowers students to explore, grow, and excel. The A.R.C. for
            Education program is not just about academic achievement; it's about
            preparing students to be the innovators, problem-solvers, and
            leaders of tomorrow. By blending these elements, we create a
            nurturing and stimulating environment where students are encouraged
            to think critically, take risks, and explore new ideas. This
            holistic approach prepares students for success in an ever-changing
            world, equipping them with the tools and mindset needed to shape a
            brighter and more transformative future.
          </p>
          <p>
            ...
            Through the synergy of these foundational elements, we aim to
            inspire and empower the next generation of thinkers, creators, and
            leaders who will drive positive change in their communities and
            beyond. By giving students the tools to succeed and the confidence
            to pursue their dreams, we help shape a future filled with
            innovation, growth, and boundless possibilities.
          </p>
        </section>
        ...
        <section className="pb-12">
          ...
          <p>
            ...
            after school program(s). We look forward to working with you to
            create a future where every student has the opportunity to learn,
            grow, and thrive.
          </p>
          <Button
